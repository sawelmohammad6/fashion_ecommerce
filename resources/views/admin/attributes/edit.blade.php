...
<div class="max-w-lg">
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-400 mt-1">Update attribute details</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.attributes.update', $attribute) }}" method="POST">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('admin.attributes.values', $attribute) }}" class="px-5 py-2.5 text-sm font-semibold rounded-lg bg-blue-500/10 text-blue-400 hover:bg-blue-500/20 transition">Manage Values</a>
